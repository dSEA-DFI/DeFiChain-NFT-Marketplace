...
<style>
    ...
    .nft_tabs tbody tr td {
        border-bottom: 1px solid #cbcbcb;
        line-height: 46px;
        font-size: 17px;
    }

    .nft_tabs table tbody,
    td,
    tfoot,
    th,
    thead,
                ...
                <div class="main_items_area">
                    <div class="back_ground_area">
                        ...
                        <div class="users_name text-center mt-5">
                            <h3 class="font-weight-normal mt-3" id="username">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Testname 1</font>
                                </font>
                            </h3>
                        </div>
                    </div>
                    <div class="row my-4">
                        <div class="col-md-5 col-12 m-auto">
                            <div class="address_boxs text-center" data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="">
                                <a class="text-decoration-none px-3 py-1 rounded-pill bg-light text-dark"
                                    rel="noopener noreferrer" id="currentAddress">
                                    <font style="vertical-align: inherit;">
                        ...
                        <div
                            class="col-md-12 m-auto has_id_area text-center d-md-flex d-block align-item-center justify-content-center">
                            <div class="icons_box d-flex">
                                <span class="" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="twitter">
                                    <a href="https://twitter.com/defichainnfts" target="_blank" class="text-decoration-none "
                                        id="tweeterurl"><i class="fab fa-twitter"></i>
                                    </a>
                                </span>
                                &nbsp;&nbsp;
                                <span class="" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="instagram">
                                    <a href="#" target="_blank" class="text-decoration-none "
                                        id="instaurl"><i class="fab fa-instagram"></i></a>
                                </span>
                        ...
                        <div class="col-md-12 col-12 m-auto mb-3">
                            <div class="text-center mt-1">
                                <font style="vertical-align: inherit;" class="text-capitalized" id="userbio">This Is My Bio </font>
                            </div>
                        </div>


                        <div class="col-md-12 m-auto text-center py-4">
                            <a href="./edit-profile.php?v=<?php echo rand();?>"
                                class="connect_wa_llets my-2 my-sm-0 mr-2 px-3" ><i class="fal fa-user-edit"></i> <span
                                    class=" ">
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;">Edit Profile</font>
                                    </font>
                                </span></a>
                        ...
                        <div class="my_tabs">
                            ...
                            <div class="d-flex m-auto align-item-center justify-content-center">
                                <ul class="nav nav-pills" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="pill" href="#menu3">My Collection</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="pill" href="#menu1">Owned</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="pill" href="#home">On Sale</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="menu3" class="container tab-pane fade active">
                                    <br>
                                    <div class="explore_star">
                                            ...
                                            <div class="col-lg-3 col-md-6 mb-5">
                                                <div class="inner_explore">
                                                    <div class="tp_pht">
                                                        ...
                                                        <a href="#" data-toggle="tooltip" data-placement="top"
                                                            title="Galaxy collection" tabindex="0">
                                                            <img src="assets/img/img1.jpg" class="ico02">
                                                        </a>
                                                    </div>
                                                    <a href="buy-description.html" class="text-decoration-none"
                                                        tabindex="0">
                                                    ...
                                                    <div class="user_name_hakf mt-1">
                                                            ...
                                                            <div class="hajaj_user text-left">
                                                                <div
                                                                    ...
                                                                    <div class="nft-card-assets">
                                                                        <img src="assets/img/img1.jpg" width="20"
                                                                            height="20" alt="Asset logo">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div
                                                            class="trx_price_heart d-flex align-items-center justify-content-between">
                                                            <a href="#" class="by_nw" tabindex="0">
                                                                Buy Now
                                                            </a>
                                                            <div class="like_save">
                                                                <span class="heart_class">
                                                                    <i class="fal fa-heart heart-black"
                                                                        aria-hidden="true"></i> &nbsp;
                                                                </span>
                                ...
                                <div id="menu5" class="container tab-pane fade">
                                    <div class="py-3">
                                        <div class="row">
                                             <div class="col-md-12">
                                                 <div class="filter mb-md-4 mb-3">
                                                     <h4>Filter</h4>
                                                     <div class="d-flex align-items-center flex-wrap" style="gap:10px">
                                                         <button onclick="filterAll()" class="btn px-md-4 px-3 text-center" style="background-color:var(--text-primary-color);">
                                                             All
                                                         </button>
                                                         <button onclick="filter('Minted')" class="btn px-md-4 px-3 text-center" style="background-color:var(--text-primary-color);">
                                                             Minted
                                                         </button>
                                                         <button onclick="filter('Bought')" class="btn px-md-4 px-3 text-center" style="background-color:var(--text-primary-color);">
                                                             Bought
                                                         </button>
                                                         <button onclick="filter('Bid')" class="btn px-md-4 px-3 text-center" style="background-color:var(--text-primary-color);">
                                                             Bid
                                                         </button>
                                                         <button onclick="filter('Sold')" class="btn px-md-4 px-3 text-center" style="background-color:var(--text-primary-color);">
                                                             Sold
                                                         </button>
...
<script>
    ...
    async function showdata() {
        var wallet_address = selectedAccount;
        if (wallet_address == '' || wallet_address == undefined) {
            ...
            fetch("./itemsdata.php", requestOptions)
                ...
                .then((ownednft) => {
                    ...
                    for (i = 0; i < ownednft.length; i++) {
                        ownedtab += `
                           <div class="col-lg-3 col-md-6 mb-5">
                           <div class="inner_explore position-relative">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="tree-dit">
                                         <div class="dropdown">
                                          <button class="dropdown-toggle btn p-0" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="color: var(--secondary-color);">
                                            <i class="bi bi-three-dots-vertical"></i>
                                          </button>
                                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="Sell.php?id=${ownednft[i].NFT_id}&v=${Math.floor((Math.random() * 1000000) + 1)}">Edit NFT</a></li> 
                                          </ul>
                                        </div>
                                    </div>
                           `;
                                   ...
                                   <div class="hajaj_user text-left">
                                       <div class="d-flex align-items-center justify-content-between">
                                           <div>
                                            ...
                                            <div class="w-100">
                                                <a href="./collection.php?collection=${ownednft[i].NFT_collection}&v=${Math.floor((Math.random() * 1000000) + 1)}" style="color:var(--text-pink)"><span class="iwMhCq">${ownednft[i].NFT_collection}</span></a>
                                           </div>                                           
                                       `;
                                       if(ownednft[i].NFT_resell == "on"){
                                        ownedtab += `<small class="hig_bg">Current Price: ${ownednft[i].NFT_price} ${ownednft[i].NFT_payment}</small>`;
                                       }
                                   ownedtab +=`</div>
                               </div>
            ...
            fetch("./itemsdata.php", requestOptions)
                ...
                .then((createnft) => {
                   ...
                   <h6 class="iwMhCq">${createnft[i].NFT_name}</h6>
                    ...
                    <div class="w-100">
                        <a href="./collection.php?collection=${createnft[i].NFT_collection}&v=${Math.floor((Math.random() * 1000000) + 1)}" style="color:var(--text-pink)"><span class="iwMhCq">${createnft[i].NFT_collection}</span></a>
                    </div>                    
                   `;
                   if(createnft[i].NFT_resell == "on"){
                    createdtab += `<small class="hig_bg">Current Price: ${createnft[i].NFT_price} ${createnft[i].NFT_payment}</small>`;
                   }
                   createdtab +=`</div>
                   </div>
                   ...
                   <div class="inner_explore position-relative">
                       <div class="tree-dit">
                                     <div class="dropdown">
                                      ...
                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="./edit-collections.php?id=${collectiondata[i].id}">Edit Collection</a></li> 
                                      </ul>
                                    </div>
                                </div>
            ...
            fetch("./itemsdata.php", requestOptions)
                ...
                .then((Salenft) => {
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="tree-dit">
                                     <div class="dropdown">
                                      ...
                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="Sell.php?id=${Salenft[i].NFT_id}&v=${Math.floor((Math.random() * 1000000) + 1)}">Edit NFT</a></li> 
                                      </ul>
                                    </div>
                                </div>
                   `;
                   ...
                   <h6 class="iwMhCq">${Salenft[i].NFT_name}</h6>
                    ...
                    <div class="w-100">
                        <a href="./collection.php?collection=${Salenft[i].NFT_collection}&v=${Math.floor((Math.random() * 1000000) + 1)}" style="color:var(--text-pink)"><span class="iwMhCq">${Salenft[i].NFT_collection}</span></a>
                    </div>                    
            ...
            fetch("./itemsdata.php", requestOptions)
               ...
               <img class="rounded-pill art_imsss" width="120px" height="120px" src="${userData[0].Userimage}" alt="Card image cap">
                    ...
                    document.getElementById("tweeterurl").setAttribute("href", `https://twitter.com/${t_name}`);
                    document.getElementById("instaurl").setAttribute("href", `https://www.instagram.com/${i_name}`);
                    document.getElementById("loadingdivnew").className = "d-none";
                });
            ...
            /*************************** Accpect functionality **************************/

            var formdata = new FormData();
            formdata.append("address", wallet_address);
            formdata.append("type", "accpect");
            ...
            fetch("./itemsdata.php", requestOptions)
                ...
                .then((accpect) => {
                    var accpecttab = "";
                    for (i = 0; i < accpect.length; i++) {
                        accpecttab += `<tr>
                   <td>${accpect[i].NFT_id}</td>
                   <td><img src="${accpect[i].NFT_image}" style="width:50px" alt=""></td>
                   <td>${accpect[i].NFT_name}</td>
                   <td>${accpect[i].Nft_quantity}</td>
                   <td>${accpect[i].NFT_bid} ${accpect[i].NFT_payment}</td>
                   <td style="color:rgb(52, 199, 123);">${accpect[i].Date}</td>
                   <td>  <a href="./onlybid.php?id=${accpect[i].NFT_id}&v=${Math.floor((Math.random() * 1000000) + 1)}"><button class="btn-con">Claim</button></a> </td>
                   </tr>
                   `;
                    } if (accpecttab == '') {
                        accpecttab += `<p>No Offers Found</p>`;
                    }
                    document.getElementById("accpect").innerHTML = accpecttab;
                    document.getElementById("loadingdivnew").className = "d-none";

                });
            /*************************** Recevied  functionality **************************/
            ...
            fetch("./itemsdata.php", requestOptions)
                ...
                .then((recive) => {
                    var recivetab = "";
                    for (i = 0; i < recive.length; i++) {
                        recivetab += `<tr>
                   <td>${recive[i].NFT_id}</td>
                   <td><img src="${recive[i].NFT_image}" style="width:50px" alt=""></td>
                   <td>${recive[i].NFT_name}</td>
                   <td>${recive[i].Nft_quantity}</td>
                   <td>${recive[i].NFT_bid} ${recive[i].NFT_payment}</td>
                   <td style="color:rgb(52, 199, 123);">${recive[i].Date}</td>
                   <td>  <button class="btn-con" onclick="accpectOffer(${recive[i].NFT_bid},${recive[i].Nft_quantity},${recive[i].NFT_id},'${recive[i].NFT_bidder}',${recive[i].Multistatus})">Accpect</button> </td>
                   </tr>
                   `;
                    } if (recivetab == '') {
                        recivetab += `<p>No Offers Found</p>`;
                    }
                    document.getElementById("recive").innerHTML = recivetab;
                    document.getElementById("loadingdivnew").className = "d-none";
        ...
        var formdata = new FormData();
            ...
            fetch("./itemsdata.php", requestOptions)
                ...
                .then((activitynft) => {
                    ...
                    let payment = '';
                    for (i = 0; i < activitynft[0].length; i++) {
                        if(activitynft[0][i].nft_type==action){
