...
$sql="SELECT `NFT_highest_bidder`,NFT_image FROM `NFT_info` WHERE NFT_id='$Tid'";
$result=mysqli_query($link,$sql);
$res=$result->fetch_assoc();
$address= $res['NFT_highest_bidder'];
$NFT_image= $res['NFT_image'];
echo $address;
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td width="480" align="center" style="color: #50579e; font-family: "Rubik", sans-serif; font-size: 35px; line-height: 150%; font-weight: 400;">
                                                                        <a href="http://test.dsea.io/index.php" target="_blank">
                                                                             <img src="http://test.dsea.io/'.$NFT_image.'" alt="" border="0" style="width: 107px;"/>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                            ...
                                            <tbody>
                                                <tr> 
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top">
                                                                        <a href="" target="_blank" data-saferedirecturl="">
                                                                            <img src="http://test.dsea.io/'.$NFT_image.'" border="0" width="105" style="display: block;" class="m_45504504110266303w80P CToWUd" />
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" width="277">
                                                        <a href="" target="_blank" data-saferedirecturl="">
                                                            <img src="http://test.dsea.io/'.$NFT_image.'" border="0" height="363" width="477" style="display: block;"
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        by activating all nftpro features.
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td bgcolor="#4e9d66" height="40" style="line-height: 40px; font-size: 40px;">&nbsp;</td>
                                            ...
                                            <tbody>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" width="64" style="line-height: 100%;">
                                                                                        ...
                                                                                        >
                                                                                           <img src="http://test.dsea.io/linkedin.png" border="0" width="30"/>
                                                                                        </a>
                                                                                    </td>
                                                                                    <td width="20" class="m_45504504110266303hide"></td>
                                                                                    <td align="left" width="32" style="line-height: 100%;">
                                                                                        <a href="https://twitter.com/" style="text-decoration: none;" target="_blank" data-saferedirecturl="">
                                                                                           <img src="http://test.dsea.io/images/twitter.png" border="0" width="30"/>
                                                                                        </a>
                                                                                    </td>
                                                                                    <td width="20" class="m_45504504110266303hide"></td>
                                                                                </tr>
                                                ...
                                                <tr>
                                                    <td bgcolor="#F5F6FB" align="center" style="color: #999999; font-family: "Rubik", sans-serif; font-size: 14px; line-height: 120%; font-weight: 400;">
                                                        Learn more about nftpro, interact with the nftpro team, engage in community discussions, and have your say in shaping the future of decentralized finance.
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td bgcolor="#F5F6FB" height="20" style="line-height: 20px; font-size: 20px;">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td bgcolor="#F5F6FB" align="center" valign="top" style="font-family: "Rubik", sans-serif; font-weight: 400; font-size: 14px; line-height: 20px;">
                                                        <a href="#" style="text-decoration: none; color: #4e9d66;" target="_blank">
                                                            © 2021 nftpro. All Rights Reserved.
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
...
if(mail($to,$subject,$txt,$headers)){
   ...
   $update="UPDATE NFT_info SET `email_send`=1 where NFT_id='$Tid'"; 
